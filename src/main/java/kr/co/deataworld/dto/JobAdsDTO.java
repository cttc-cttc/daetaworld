...
public class JobAdsDTO {
	...
	public String toString() {
		return "JobAdsDTO [a_number=" + a_number + ", a_date=" + a_date + ", a_time=" + a_time + ", a_wage=" + a_wage
				+ ", a_need=" + a_need + ", a_filled=" + a_filled + ", a_urgency=" + a_urgency + ", a_status="
				+ a_status + ", ua_date=" + ua_date + ", m_id=" + m_id + ", r_code=" + r_code + ", s_number=" + s_number
				+ ", del=" + del + ", job_code=" + job_code + "]";
	}
	...
	public int getA_filled() {
		return a_filled;
	}

	public void setA_filled(int a_filled) {
		this.a_filled = a_filled;
	}
