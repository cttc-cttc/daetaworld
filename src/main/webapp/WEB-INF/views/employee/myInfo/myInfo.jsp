														...
														<div class="row mb-30">
															<div class="col-lg-2">
																<div class="profile-avatar mb-30">																					
																	...
																	<tr>
																		<td>
																			<img style="height:200px; width:150px;" src="${contextPath}/displayProfile?fileName=${myInfo.m_picture}"></td>
																		<td>
																	</tr>																	
																	<tr>																	
																...
																<div class="row">
																	...
																	<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
																		...
																		<div class="single-input mb-25">
																			...
																			<input type="checkbox" id="m_terms1" name="m_terms1">
																				<c:set var="terms1" value="${myInfo.m_terms1 }"/>																				
																					<c:if test="${terms1 == 1}">
																						<c:out value="checked"/>
																					</c:if>
																			<label for="m_terms2">선택약관2</label>
																			<input type="checkbox" id="m_terms2" name="m_terms2">
