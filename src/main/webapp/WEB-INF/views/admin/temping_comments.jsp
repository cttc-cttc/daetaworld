...
<body class="template-color-1">
																...
																<c:forEach var="list" items="${tempingComments }">
																	<tr class="application-item">
																		...
																		<td class="view-application">
																			<a href="javascript:deleteComments(${list.c_number}, '${list.m_id }')" class="view-application">댓글삭제</a>&nbsp;&nbsp;
	...
	<script>
		function deleteComments(c_num, m_id) {
			if(confirm('신고된 땜빵게시판 댓글을 삭제할까요?'))
				location.href = '${contextPath }/admin/warn_temping_comments?c_num='+c_num +'&m_id='+m_id;
		}
