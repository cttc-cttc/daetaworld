																...
																<c:forEach var="list" items="${tempingComments }">
																	<tr class="application-item">
																		<td class="application-job text-left">
																			<h3><a class="text-ellipsis" href="${contextPath }/board/temping/detail?b_number=${list.b_number }">${list.c_contents }</a></h3>
																		</td>
	...
	<script>
		function deleteComments(c_num) {
			if(confirm('신고된 땜빵게시판 댓글을 삭제할까요?'))
				location.href = '${contextPath }/admin/warn_temping_comments?c_num='+c_num;
		}
