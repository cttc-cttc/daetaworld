										...
										<div class="profile-applications mb-50">
											<div class="profile-applications-heading">
												<ul class="nav">
													...
													<li><a class="active" href="${contextPath}/reviewMapper/e_writtenReviews?m_id=${loginInfo.m_id}">나를 평가한 후기</a></li>											
												</ul>
											</div>
												...
												<div class="profile-applications-form">
													<table class="table table-striped">
														...
														<c:forEach var="adsList" items="${list}">
															<tr>			
																<td><a href="writtenDetail?w_number=${adsList.w_number }&s_name=${adsList.s_name }">
																	${adsList.s_name }</a></td>													
