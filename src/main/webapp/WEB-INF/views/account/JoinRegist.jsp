...
<!--     <link rel="stylesheet" type="text/css" href="https://contents.albamon.kr/webpack/dist/css/join-sv-202111180935.css" /> -->
    ...
    <script type="text/javascript" src="/Scripts/js/ga/ga360.js?20220825"></script>
    <script type="text/javascript" src="/Scripts/js/layout/layout.totsearch.js"></script>
    <script type="text/javascript" src="/Scripts/js/layout/layout.common.js?20220825"></script>
...
pageviewObj.title ='홈>개인회원가입>일반회원가입';
pageviewObj.dimension1 ='170313650.1658204024';
pageviewObj.dimension2 ='';
pageviewObj.dimension3 ='';
pageviewObj.dimension4 ='PC';
pageviewObj.dimension52 ='1661407159.694';
...
<script async src='https://www.googleoptimize.com/optimize.js?id=OPT-WBB38HG'></script>
    ...
    <script type="text/javascript" src="/Scripts/js/common/braze.js?20220825"></script>
</head>
<body id="" >
...
<div id="header">
    <div id="gnb">
        <h1>
            <a href="/"><img src="${contextPath}resources/images/logo.png"  class="png" width="160" height="53" alt="오늘의대타" /></a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="2" class="howAlbamon">
                                        <span class="select" style="color:#78838e">[선택]</span> 오늘의대타를 어떻게 알게 되셨나요?
...
<option value="A00">기타(버스, 지하철, 판촉물 등)</option>
                ...
                <div class="btnBx">
                	<!--   <img src="${contextPath}/resources/assets/images/companies_logo/logo-100/logo1.jpg" alt="가입하기"> -->
                      <a href="#" id="btn_submit"><img src="${pageContext.request.contextPath}/resources/assets/images/btn_user_join0.png" alt="가입하기"></a> 
            </div>
            <!-- 회원가입폼 끝 //-->
</form>    </div>
    <!-- 회원가입 끝 //-->
