...
<div class="inner-modal">
   	<!-- 서비스 이용약관 동의 -->
    <div class="modal fade start" id="modal_terms1" tabindex="-1" role="dialog" aria-hidden="true">
    	<div class="modal-dialog modal-lg">
	    	<div class="modal-content content-size">
		        <div class="agree_terms">
					<!-- Modal Header -->
					<div class="modal-header">
						<h2 class="modal-title title-size">서비스 이용약관</h2>
   	...
   	<!-- 개인정보 수집 및 이용 동의 -->
    <div class="modal fade start" id="modal_terms2" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
	    	<div class="modal-content content-size">
		        <div class="agree_terms">
		        	<!-- Modal Header -->
					<div class="modal-header">
						<h2 class="modal-title title-size">개인정보 수집 및 이용</h2>
				        <button type="button" class="close" data-dismiss="modal">&times;</button>
					</div>
					<!-- Modal body -->
					<div class="modal-body body-font">
   	...
   	<!-- 개인정보 마케팅 활용 동의 -->
    <div class="modal fade start" id="modal_terms3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
	    	<div class="modal-content content-size">
		        <div class="agree_terms">
		        	<!-- Modal Header -->
					<div class="modal-header">
						<h2 class="modal-title title-size">개인정보 마케팅 활용</h2>
				        <button type="button" class="close" data-dismiss="modal">&times;</button>
					</div>
					<!-- Modal body -->
					<div class="modal-body body-font">
    ...
    <div class="modal fade start" id="modal_terms4" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
	    	<div class="modal-content content-size">
		        <div class="agree_terms">
		        	<!-- Modal Header -->
					<div class="modal-header">
						<h2 class="modal-title title-size">광고성 정보 이메일/SMS 수신</h2>
				        <button type="button" class="close" data-dismiss="modal">&times;</button>
					</div>
					<!-- Modal body -->
					<div class="modal-body body-font">
